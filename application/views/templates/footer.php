            ...
            <div class="footer-wrapper">
                <div class="container">
                    <div class="row add-clearfix same-height">
                            ...
                            <ul class="recent-posts">
                                <li>
                                    ...
                                    <div class="post-content">
                                        <a href="#" class="post-title">Website design trends for 2019</a>
                                        <p class="post-meta">By <a href="#">Admin</a> . 22 Nov, 2019</p>
                                    </div>
                                </li>
                                <li>
                                    <a href="#" class="post-author-avatar"><span><img src="http://placehold.it/50x50" alt=""></span></a>
                                    <div class="post-content">
                                        ...
                                        <p class="post-meta">By <a href="#">Admin</a> . 12 Nov, 2019</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <h5 class="section-title box">About javaXcode</h5>
                            <p>javaXcode bergerak di bidang custom web application, web desain, web development, maintenance, dan web hosting.</p>
    ...
    <script type="text/javascript" src="<?= base_url() ?>assets/components/jquery.sky.carousel/jquery.sky.carousel-1.0.2.js"></script>
