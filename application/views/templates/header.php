...
<head>
    <!-- Page Title -->
    <title>javaXcode | Professional Web Development</title>
    
    <link rel="shortcut icon" href="<?= base_url() ?>assets/images/jxc_logo1.png" />

    <!-- Meta Tags -->
    <meta charset="utf-8">
    <meta name="description" content="javaXcode | custom web application, web design, web development, maintenance, dan web hosting">
    <meta name="author" content="javaXcode">
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/components/jquery.sky.carousel/skin-variation.css" media="screen" />
