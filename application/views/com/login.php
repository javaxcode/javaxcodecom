<div class="page-title-container style5">
    <div class="page-title">
        <div class="container">
            <h1 class="entry-title">Login ke Member Area</h1>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn style2">Login Now</button>
                            </div>
                            <div class="form-group">

                                <label>Belum Jadi Member ? <a href="registrasi">DAFTAR</a></label>
